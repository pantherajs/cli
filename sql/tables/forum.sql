...
CREATE TABLE IF NOT EXISTS forum (
  ...
  CONSTRAINT forum_primary_key                 PRIMARY KEY (id),
  CONSTRAINT forum_foreign_key_category_id     FOREIGN KEY (category_id)     REFERENCES category(id),
  CONSTRAINT forum_foreign_key_parent_forum_id FOREIGN KEY (parent_forum_id) REFERENCES forum(id),
  CONSTRAINT forum_unique_name                 UNIQUE      (name)
);
