/**
 * @file test/tasks/prompts/get-database-name.spec.js
 */
'use strict';
...
const include = proxyquire('../../../bin/tasks/prompts/get-database-name', stubs);
...
test('should set `ctx.env.PANTHERA_DB_NAME`', t => {
  const context = {
    env: {},
    parent: {
      task: {},
  ...
  t.true(context.env.PANTHERA_DB_NAME === 'hello, world');
});
