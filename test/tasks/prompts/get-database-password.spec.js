/**
 * @file test/tasks/prompts/get-database-password.spec.js
 */
'use strict';
...
const include = proxyquire('../../../bin/tasks/prompts/get-database-password', stubs);
...
test('should set `ctx.env.PANTHERA_DB_PASS`', t => {
  const context = {
    env: {},
    parent: {
      task: {},
  ...
  t.true(context.env.PANTHERA_DB_PASS === 'hello, world');
});
